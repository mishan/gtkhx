...
main (int argc, char **argv)
{
	...
	g_test_add_func ("/prefs_parser/bool_no",
	                 test_bool_no);
	g_test_add_func ("/prefs_parser/bool_single_letter_f",
	                 test_bool_single_letter_f);

	g_test_add_func ("/prefs_parser/bool_shipped_regression_gkeyfile_true_false",
	...
	g_test_add_func ("/prefs_parser/bool_null_out_pointer_just_returns_recognition",
