...
test_strip_ansi_passes_through_si_and_syn (void)
{
	...
	char buf[] = "\x0f" "format" "\x0f" "chunk" "\x16" "data" "\x16";
	const gsize len = sizeof (buf) - 1;
	char copy[32];
	memcpy (copy, buf, sizeof (buf));
	strip_ansi (buf, len);
...
main (int argc, char **argv)
{
	...
	g_test_add_func ("/text_sanitisers/cr2lf_simple",
	                 test_cr2lf_simple);
	g_test_add_func ("/text_sanitisers/cr2lf_no_cr_unchanged",
	                 test_cr2lf_no_cr_unchanged);
	g_test_add_func ("/text_sanitisers/cr2lf_only_cr",
	                 test_cr2lf_only_cr);
	...
	g_test_add_func ("/text_sanitisers/lf2cr_simple",
	                 test_lf2cr_simple);
	...
	g_test_add_func ("/text_sanitisers/strip_ansi_passes_through_printable_ascii",
