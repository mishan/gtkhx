...
static void
ba_append_thread_hdr (GByteArray *ba, guint32 postid, guint32 parentid,
                      guint16 base_year, guint16 date_pad, guint32 seconds,
                      guint16 partcount)
{
...
test_newscat_single_post_no_parts (void)
{
    ...
    ba_append_thread_hdr (ba, 0x00000042, /* postid */
                          0,              /* parentid */
                          2026,           /* base_year */
                          0,              /* date_pad */
                          12345,          /* seconds */
...
test_newscat_short_header_rejected (void)
{
    ...
    wire_fixture_init (&htlc, HTLS_HDR_TASK, 1, 0);
    wire_fixture_add_chunk (&htlc, HTLC_DATA_CATLIST, sizeof (short_bytes),
                            short_bytes);
...
main (int argc, char **argv)
{
    ...
    g_test_add_func ("/proto/newscat/empty_list", test_newscat_empty_list);
