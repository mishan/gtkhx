...
test_msg_event_typical (void)
{
	...
	HxMsgEvent *e = hx_msg_event_new (42,
	                                  name, strlen (name),
	                                  body, strlen (body),
	                                  NULL);
...
test_msg_event_broadcast_when_uid_zero (void)
{
	...
	HxMsgEvent *e = hx_msg_event_new (0,
	                                  "Server", 6,
	                                  "back in 5", 9,
	                                  NULL);
...
{
	HxMsgEvent *e = hx_msg_event_new (1,
	                                  "bob", 3,
	                                  "hi", 2,
	                                  NULL);
	g_assert_false (e->is_broadcast);
...
{
	HxMsgEvent *e = hx_msg_event_new (7,
	                                  "misha", 5,
	                                  "self-message echo", 17,
	                                  "misha");
...
test_msg_event_preserves_uid (void)
{
	...
	HxMsgEvent *e = hx_msg_event_new (0xbeef,
	                                  "x", 1, "y", 1, NULL);
...
main (int argc, char **argv)
{
	...
	g_test_add_func ("/proto/msg_event/typical",
	                 test_msg_event_typical);
