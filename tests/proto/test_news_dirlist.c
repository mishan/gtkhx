...
test_categoryitem_folder (void)
{
	 ...
	 * no trailing padding. */
    const guint8 wire[] = { 0x00, 0x02, /* ntype = 2 */
                            0x00, 0x04, /* count = 4 */
                            0x12,       /* namelen = 18 */
                            'A',  'd',  'm', 'i', 'n', ' ', 'B', 'a', 'd',
                            'M',  'o',  'o', 'n', ' ', 'I', 'n', 'f', 'o' };
...
test_categoryitem_folder_with_trailing_padding (void)
{
    ...
    const guint8 wire[]
        = {
              0x00, 0x02, 0x00, 0x04, 0x12, 'A', 'd', 'm',
              'i',  'n',  ' ',  'B',  'a',  'd', 'M', 'o',
              'o',  'n',  ' ',  'I',  'n',  'f', 'o', 0x4e /* trailing pad */
          };
    struct hx_news_dirlist_entry e;
    g_assert_true (hx_news_dirlist_parse_categoryitem (wire, sizeof wire, &e));
...
test_categoryitem_category (void)
{
    ...
    const guint8 wire[] = {
        ...
        0x0a,                   /* namelen = 10 */
        'G',  'u',  'e',  's',  't',  ' ', 'B',
        'o',  'o',  'k',  0x30, 0x00, 0x00 /* trailing pad */
    };
    struct hx_news_dirlist_entry e;
    g_assert_true (hx_news_dirlist_parse_categoryitem (wire, sizeof wire, &e));
...
test_categoryitem_rejects_unknown_ntype (void)
{
    ...
    const guint8 wire[] = { 0x00, 0x63, /* ntype = 99 */
...
test_categoryitem_rejects_namelen_overrun (void)
{
    ...
    const guint8 wire[] = {
        0x00, 0x02, 0x00, 0x00, 0x0a, /* namelen claims 10 */
...
test_categoryitem_null_out_returns_false (void)
{
    ...
    g_assert_false (
        hx_news_dirlist_parse_categoryitem (wire, sizeof wire, NULL));
}
...
test_folderitem_folder (void)
{
    ...
    const guint8 wire[] = { 0x01, /* ntype = 1 (folder) */
                            'A',  'd', 'm', 'i', 'n', ' ', 'B', 'a', 'd',
                            'M',  'o', 'o', 'n', ' ', 'I', 'n', 'f', 'o' };
    struct hx_news_dirlist_entry e;
...
test_folderitem_category (void)
{
    ...
    const guint8 wire[] = { 0x02, /* ntype = 2 (category) */
                            'G',  'u', 'e', 's', 't', ' ', 'B', 'o', 'o', 'k' };
    struct hx_news_dirlist_entry e;
    g_assert_true (hx_news_dirlist_parse_folderitem (wire, sizeof wire, &e));
    g_assert_cmpint (e.kind, ==, 2);
...
main (int argc, char **argv)
{
    ...
    g_test_add_func (
        "/proto/news_dirlist/categoryitem_folder_with_trailing_padding",
    ...
    g_test_add_func (
        "/proto/news_dirlist/categoryitem_rejects_truncated_header",
    ...
    g_test_add_func ("/proto/news_dirlist/"
                     "categoryitem_rejects_folder_truncated_before_namelen",
                     test_categoryitem_rejects_folder_truncated_before_namelen);
    g_test_add_func (
        "/proto/news_dirlist/"
        "categoryitem_rejects_category_truncated_before_namelen",
