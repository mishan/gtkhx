...
/* Phase 5: drop the broadcast-dedupe state. Called from hx_htlc_close
 * so a reconnection re-shows the first instance of any repeated
 * server message. */
extern void broadcastmsg_session_reset (void);
