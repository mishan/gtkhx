...
G_DECLARE_FINAL_TYPE (HxLocalFilesProvider, hx_local_files_provider,
                      HX, LOCAL_FILES_PROVIDER, GObject)
...
extern HxLocalFilesProvider *hx_local_files_provider_new (const char *initial_path);
 ...
 * change. */
extern GListModel *hx_local_files_provider_get_listing      (HxLocalFilesProvider *self);
extern const char *hx_local_files_provider_get_current_path (HxLocalFilesProvider *self);
extern const char *hx_local_files_provider_get_label        (HxLocalFilesProvider *self);
