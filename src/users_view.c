...
/* compat.h (via hx.h) provides the _ () gettext macro this TU uses. */
#include "hx.h"
#include "gtkhx.h"  /* gtkhx_apply_userlist_style */
#include "msg.h"    /* msgwin_with_uid + create_msgwin */
#include "chat_tabs.h"
#include "users.h"  /* user_popup_show */
#include "users_row.h"
#include "users_cell.h" /* HxUserCellName — the custom Name cell (C leaf) */
#include "users_view.h"
#include "gtkhx_theme.h" /* gtkhx_theme_get_default (on_theme_changed) */
#ifdef HAVE_VOICE
