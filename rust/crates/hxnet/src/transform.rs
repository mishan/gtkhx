...
//!
//! Note that the dyn-dispatch cost is one indirect call per
//! `poll_read` / `poll_write` — negligible against the syscall the
//! call usually triggers, and constant per polled future.
