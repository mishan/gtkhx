...
//!   logs buffer #1 and every 50th, ~6.4 s of audio at the default
//!   128 ms ptime. Useful for "is audio actually flowing?" questions
//!   and pinpointing where it stops if it isn't.
//!
//! ## Usage
//!
//! ```ignore
